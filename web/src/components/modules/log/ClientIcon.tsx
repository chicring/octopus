    ...
    return (
        <Tooltip>
            <TooltipTrigger asChild>
                <span className={`inline-flex items-center justify-center shrink-0 rounded-full overflow-hidden ring-1 ring-border/30 bg-white dark:bg-neutral-600 ${className ?? 'size-4'}`}>
                    <Image
                        src={config.icon}
                        alt={clientName}
                        width={16}
